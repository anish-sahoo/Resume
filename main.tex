...
% -------------------------------------------
    ...
    \resumeSubheadingSmall{PawHacks}{December 2023 -- Present}
      ...
      \resumeItemListStart
        \resumeItem
          {Conducted technical interviews for applicants and mentor the website team for PawHacks 2.0}
      \resumeItemListEnd
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeProjectHeading
      {\textbf{EasyClassPlanner} $|$ \emph{Rust, TypeScript, React.js}}{May 2024}
      \resumeItemListStart
...
\begin{itemize}[leftmargin=0.15in, label={}]
   \small{\item{
    ...
    \textbf{AI/Data Science}{: NumPy, Jupyter Notebooks, PyTorch, Gymnasium}
   }}
\end{itemize}
