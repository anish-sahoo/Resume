...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        % \resumeItem{GPA: 3.871/4.0, Major GPA: 3.947/4.0, Concentration in Artificial Intelligence, Dean's List (every semester)}
        % \resumeItem{Major GPA: 3.947/4.0, Concentration in AI, Dean's List (every semester)}
        ...
        % \resumeItem{Relevant Coursework: Database Design, Object Oriented Design, Algorithms, Artificial Intelligence, Mathematics of Data Models, Discrete Structures, Fundamentals of Computer Science 1 \& 2}
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeProjectHeading
      {\textbf{AI Hoops} $|$ \emph{Python, PyTorch, OpenAI Gymnasium}}{August 2024}
      \resumeItemListStart
      ...
      \resumeProjectHeading
        {\textbf{Map of all Anime} $|$ \emph{JavaScript, Python, PixiJS, TensorFlow, MongoDB}}{July 2024}
        \resumeItemListStart
          \resumeItem{Created a map of the top 5000 anime scraped from MyAnimeList using embeddings and t-SNE}
          \resumeItem{Implemented complex filtering mechanisms and search functionality using PixiJS for exploring the map}
        \resumeItemListEnd

    \resumeProjectHeading
      {\textbf{EasyClassPlanner} $|$ \emph{Rust, TypeScript, React}}{May 2024}
      \resumeItemListStart
    ...
    \resumeProjectHeading
      {\textbf{X Finance (X Developer Challenge)} $|$ \emph{Python, TypeScript, React, X API, xAI API}}{April 2024}
      \resumeItemListStart
