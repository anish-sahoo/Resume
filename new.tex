...
% -------------------------------------------
  ...
  \resumeItemListStart
    % \resumeItem{Developed and optimized high-throughput REST and gRPC services using Java Spring, improving backend performance and database efficiency}
    ...
    % \resumeItem{Built a scalable Kafka-based system for real-time hotel price tracking and notifications for millions of customers.}
    % \resumeItem{Created and deployed a customer preference inference system using heuristics to predict user interests, with plans for ML expansion}
