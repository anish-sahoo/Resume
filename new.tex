...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        \resumeItem{GPA: 3.86/4.0, Expected Graduation: December 2026, Honors: Dean's List (every semester), AI Concentration}
...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
   \textbf{Languages}{: Java, Python, SQL, JavaScript, TypeScript, LaTeX, Kotlin, Rust } \\  
   \textbf{Technologies}{: Java Spring/Spring Boot, Node.js, Express.js, gRPC, GraphQL, Apache Kafka, Apache Solr} \\  
   \textbf{Databases}{: PostgreSQL, MySQL, SQLite, MongoDB, Redis, BigQuery, Bigtable} \\  
   \textbf{DevOps/Tooling}{: Git, GitHub, Maven, Bash, Linux, Caddy Server} \\  
   \textbf{Cloud/Observability}{: Google Cloud Platform (GCP), Kubernetes, Docker, Aiven, NewRelic, Lightrun, Splunk} \\  
   \textbf{AI/Data Science}{: PyTorch, NumPy, Gymnasium, Jupyter, PettingZoo}  
  }}
\end{itemize}
...
% -------------------------------------------
  ...
  \resumeItemListStart
    \resumeItem{adsfdsdfsdf}
    \resumeItem{asdasdasd}
    \resumeItem{asdasdasdasd}
    \resumeItem{asdasdasdasd}
  \resumeItemListEnd


  \resumeSubheadingSmall{Software Engineer/Organizer}{December 2023 -- Present}
    \resumeSubSubheading
