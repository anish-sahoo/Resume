...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
   \textbf{Languages}{: Java, Python, SQL, JavaScript, TypeScript, LaTeX, Kotlin, HTML/CSS } \\  
   \textbf{Technologies}{: Spring Boot, gRPC, REST, Apache Kafka, JUnit 5, Node.js, Express.js, React.js, GraphQL} \\  
   \textbf{Databases}{: MySQL, BigQuery, MongoDB, SQLite, Bigtable, PostgreSQL, Redis} \\
   \textbf{DevOps/Tooling}{: Git, CI/CD (GitHub Actions, GitOps, ArgoCD), Docker, Maven, Linux, Kubernetes} \\
   \textbf{Cloud/Monitoring}{: Google Cloud Platform, NewRelic, Lightrun, Splunk} \\
   \textbf{AI/Data Science}{: PyTorch, NumPy, Gymnasium, Jupyter, PettingZoo, Matplotlib}  
  }}
\end{itemize}
...
% -------------------------------------------
  ...
  \resumeItemListStart
    \resumeItem{Developed scalable REST and gRPC microservices in Spring for personalization and recommendation services}%and integrating technologies like Kafka, Bigtable, and BigQuery}
    % \resumeItem{Built and maintained scalable REST and gRPC microservices in Java Spring, supporting high-throughput data products and powering key recommendation and personalization features}
    ...
    \resumeItem{Collaborated closely with product, data, and engineering teams in an Agile environment to deliver high-impact features under tight deadlines, balancing technical depth, clear communication, and time management}%, balancing technical complexity with clear and consistent communication}
  \resumeItemListEnd
