...
\begin{center}
    ...
    Available January-August 2026 at Boston, San Francisco, NYC \& Seattle %$|$ Backend role preferred
\end{center}
...
% Update unified consumption schema and priceapi to add currency support DS-41701
% Update protobuf pom for nexus (not a ticket but a small fix)
% Add no args constructor to custapi and add a java17 release DS-42447
% Hotel price watch alerts DS-42622 - kafka setup and database update
% Hotel price watch part 2 DS-42932 - new relic logging, messaging team, check if user booked hotel
% Vector api POC with google - to use google’s knowledge graph and other vertex ai tools to create recommendations
% Customer preferences poc - create a heuristics based system (later ml) to compute what preferences a customer has
% Find what values are causing a bug in custactivityapi using Lightrun - ended 
%   up being a bug will getOfferToken. Also found out that if you run java hotspot without a flag, it will show the 
%   stack trace for NPE only once and then empty stack traces after

\section{Technical Skills}
% \begin{itemize}[leftmargin=0.15in, label={}]
%    \small{\item{
%     \textbf{Languages}{: Java, Python, SQL, JavaScript, TypeScript, Kotlin, LaTeX} \\  
%     \textbf{Technologies}{: Java Spring, Node.js, Express.js, REST Api, gRPC, GraphQL, Kafka, Solr} \\  
%     \textbf{Databases}{: PostgreSQL, MySQL, SQLite, MongoDB, Redis, BigQuery, Bigtable} \\  
%     \textbf{Tooling}{: Git, GitHub, Maven, Bash, Linux} \\  
%     \textbf{Infrastructure}{: Google Cloud Platform (GCP), Kubernetes, Docker, Caddy Server, Aiven, NewRelic, Lightrun, Splunk} \\  
%     \textbf{AI/Data Science}{: PyTorch, TensorFlow, NumPy, Gymnasium, Jupyter}  
%    }}
% \end{itemize}
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
   \textbf{Languages}{: Java, Python, SQL, JavaScript, TypeScript, LaTeX, Kotlin, HTML/CSS } \\  
   \textbf{Technologies}{: Spring, gRPC, GraphQL, Apache Kafka, Node.js, Express.js, React.js, Apache Solr, JUnit 5} \\  
   \textbf{Databases}{: MySQL, BigQuery, MongoDB, SQLite, Bigtable, PostgreSQL, Redis} \\  
   \textbf{DevOps/Tools}{: Git, GitHub, Maven, Bash, Linux, Caddy Server} \\  
   \textbf{Cloud/Observability}{: Google Cloud Platform (GCP), Kubernetes, Docker, Aiven, NewRelic, Lightrun, Splunk} \\  
...
% -------------------------------------------
  ...
  % \resumeItem{Built a heuristic-driven system to infer customer preferences, laying the groundwork for ML-based personalization}
    ...
    \resumeItem{Developed and maintained high-throughput REST and gRPC services in Java Spring for various data products}%and integrating technologies like Kafka, Bigtable, and BigQuery}
  ...
  \resumeSubheadingSmall{PawHacks}{December 2023 -- May 2024}
    \resumeSubSubheading
    {Software Engineer/Organizer}{}%May 2024 - Present}
    \resumeItemListStart
      \resumeItem{Collaborated with 15 classmates to host a hackathon with over 120 attendees and \$3000+ worth of prizes}
      \resumeItem{Developed and deployed the full-stack \underline{pawhacks.io} hackathon website with over 10000 visits}
    \resumeItemListEnd
...
\resumeSubHeadingListStart
  ...
  \resumeProjectHeading
    ...
    \resumeItemListStart
      \resumeItem{Developed a multi-agent version of the Proximal Policy Optimization (PPO) algorithm, inspired by the \href{https://arxiv.org/abs/1707.06347}{\underline{PPO}} and \href{https://arxiv.org/abs/2103.01955}{\underline{MAPPO}} papers, that enhances agent cooperation by integrating a shared actor-critic architecture}
      \resumeItem{Trained agents in the KAZ environment to cooperate and achieve shared survival goals by fighting off zombies}
    \resumeItemListEnd
