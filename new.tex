...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
   ...
   \textbf{Technologies}{: Spring, REST, gRPC, GraphQL, Apache Kafka, Node.js, Express.js, React.js, Apache Solr, JUnit 5} \\  
   \textbf{Databases}{: PostgreSQL, MySQL, SQLite, MongoDB, Redis, BigQuery, Bigtable} \\  
...
% -------------------------------------------
  ...
  % \resumeItem{Built a heuristic-driven system to infer customer preferences, laying the groundwork for ML-based personalization}
    ...
    \resumeItem{Developed a heuristic-driven customer preferences system combining real-time event processing and batch jobs to infer user interests, enabling dynamic personalization and laying the groundwork for future ML integration}
    \resumeItem{Worked on multiple recommendation and personalization projects, including a proof-of-concept integrating Google's Knowledge Graph and Vertex AI to evaluate performance against in-house RAG-based recommendation system}
  \resumeItemListEnd
  ...
  \resumeSubheadingSmall{Software Engineer/Organizer}{December 2023 -- May 2024}
    \resumeSubSubheading
    {PawHacks}{}%May 2024 - Present}
    \resumeItemListStart
      \resumeItem{Collaborated with 15 classmates to host a hackathon with over 120 attendees and \$3000+ worth of prizes}
      \resumeItem{Developed and deployed the full-stack \underline{\href{https://pawhacks.io}{pawhacks.io}} hackathon website with over 10000 visits}
    \resumeItemListEnd
