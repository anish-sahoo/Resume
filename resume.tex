...
% -------------------------------------------
  ...
  \resumeSubheadingSmall{PawHacks}{December 2023 -- May 2024}
    ...
    \resumeItemListStart
      ...
      \resumeItem{Managed backend infrastructure and contributed to code for the \href{https://web.archive.org/web/20241229024348/https://pawhacks.io/}{\underline{pawhacks.io}} website with 10000+ visits}
    \resumeItemListEnd
...
\resumeSubHeadingListStart
  ...
  \resumeProjectHeading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Integrated PostgreSQL, Elasticsearch, and Redis using Spring Boot for a fault-tolerant, low-latency system for personalized search and recommendations on over 5000 anime scraped from MyAnimeList}
